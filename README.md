...
Baseline model for [insuranceqa-corpus-zh](https://github.com/chatopera/insuranceqa-corpus-zh/wiki)
...
下载[文档](./deep_qa_1/baseline_article.pdf)了解更多关于 DeepQA-1 的实现和 Baseline。
